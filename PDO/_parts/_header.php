...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" style="color:white">
  ...
  <div
    ...
    style="
      background-image: url('images/nada2.jpg');
      height: 250px; border: 5px solid white; border-top: 37px solid white;">
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6); margin-top: 13px;">
